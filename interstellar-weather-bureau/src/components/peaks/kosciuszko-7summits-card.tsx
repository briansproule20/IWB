...
export default function Kosciuszko7SummitsCard() {
  ...
  return (
    <div className="flex h-full flex-col space-y-2">
      <div>
        <h3 className="text-lg font-bold text-gray-900 dark:text-white">Mount Kosciuszko</h3>
        <p className="text-xs text-gray-500">{continent} • New South Wales</p>
      </div>
      <div className="flex-1 space-y-2">
        <div className="grid grid-cols-2 gap-3">
          ...
          <div>
            ...
            <div className="text-xs text-gray-600 dark:text-gray-400">Seventh highest</div>
          </div>
        </div>
      ...
      <div className="text-xs text-gray-400">36°27′S 148°16′E</div>
    </div>
  );
}
