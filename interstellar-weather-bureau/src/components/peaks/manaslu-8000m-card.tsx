...
export default function Manaslu8000mCard() {
  const [weather, setWeather] = useState<any>(null);
  const heightM = 8163;
  const heightFt = 26781;
  const prominence = 3092;

  useEffect(() => {
    fetch('/api/weather/manaslu')
      .then(res => res.json())
  ...
  return (
    <div className="flex h-full flex-col space-y-2">
      <div>
        <h3 className="text-lg font-bold text-gray-900 dark:text-white">Manaslu</h3>
      ...
      <div className="flex-1 space-y-2">
        ...
        <div className="space-y-2">
          <div className="rounded-lg bg-blue-50 p-2 dark:bg-blue-900/20">
            ...
            <div className="text-lg font-bold text-blue-900 dark:text-blue-200">#8 of 14 Eight-thousanders</div>
          </div>
          <div className="space-y-2">
      ...
      <div className="text-xs text-gray-400">28°33′N 84°34′E</div>
    </div>
  );
}
