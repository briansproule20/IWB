...
export default function BroadPeak8000mCard() {
  const [weather, setWeather] = useState<any>(null);
  const heightM = 8051;
  const heightFt = 26414;
  const prominence = 1701;

  useEffect(() => {
    fetch('/api/weather/broad-peak')
      .then(res => res.json())
  ...
  return (
    <div className="flex h-full flex-col space-y-2">
      <div>
        <h3 className="text-lg font-bold text-gray-900 dark:text-white">Broad Peak</h3>
      ...
      <div className="flex-1 space-y-2">
        ...
        <div className="space-y-2">
          <div className="rounded-lg bg-blue-50 p-2 dark:bg-blue-900/20">
            ...
            <div className="text-lg font-bold text-blue-900 dark:text-blue-200">#12 of 14 Eight-thousanders</div>
          </div>
          <div className="space-y-2">
      ...
      <div className="text-xs text-gray-400">35°49′N 76°34′E</div>
    </div>
  );
}
