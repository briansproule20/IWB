...
export default function Makalu8000mCard() {
  const [weather, setWeather] = useState<any>(null);
  const heightM = 8485;
  const heightFt = 27838;
  const prominence = 2386;

  useEffect(() => {
    fetch('/api/weather/makalu')
      .then(res => res.json())
  ...
  return (
    <div className="flex h-full flex-col space-y-2">
      <div>
        <h3 className="text-lg font-bold text-gray-900 dark:text-white">Makalu</h3>
      ...
      <div className="flex-1 space-y-2">
        ...
        <div className="space-y-2">
          <div className="rounded-lg bg-blue-50 p-2 dark:bg-blue-900/20">
            ...
            <div className="text-lg font-bold text-blue-900 dark:text-blue-200">#5 of 14 Eight-thousanders</div>
          </div>
          <div className="space-y-2">
      ...
      <div className="text-xs text-gray-400">27°53′N 87°05′E</div>
    </div>
  );
}
